<template>
    <div>
        ...
        <div class="my-6">
            ...
            <div class="fixed z-10 inset-0 overflow-y-auto" v-show="cusModal">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                        ...
                        <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                            ...
                            <h1 class="mb-8 text-3xl text-center"></h1>

                            <div class="max-w mx-auto my-5 px-5 tbl-fixed drop-shadow-md">
                                ...
                                <table class="table-auto border-spacing-px min-w-max ">
                                    ...
                                    <tbody>
                                        <tr v-for="item in order_id" :key="item.order_id">
                                            ...
                                            <td>
                                                <button @click="getline(item)"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="40" height="20" viewBox="0 0 15 13" id="detail"
                                                        class=" hover:bg-orange-500 rounded-md">
            ...
            <div class="item-center">
                        ...
                        <tbody>
                            <tr v-for="book in books" :key="book.isbn">
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                                    {{ book.book_type }}</td>
                                <td><button class="mb-2.5 hover:bg-orange-500 rounded-md" @click="edit(book)"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 100 100"
                                            id="create">
                                            <path
                                            ...
                                            <path fill="#00F" d="M1644-650v1684H-140V-650h1784m8-8H-148v1700h1800V-658z">
                                            </path>
                                        </svg></button>
                                    <button @click="del(book)" class="my-auto  hover:bg-orange-500 p-1 rounded-md"> <svg
                ...
                <!-- cus -->
                <div class="flex">
                    <div class=" my-5 max-w mx-auto px-5 tbl-fixed drop-shadow-md">
                            ...
                            <tbody>
                                <tr v-for="cus in customer" :key="cus.customer_id">
                                    ...
                                    <td><button @click="cusorder(cus)"><svg xmlns="http://www.w3.org/2000/svg" width="32"
                                                height="30" id="history" class=" hover:bg-orange-500 rounded-md">
                                                <path
